...
class TransactionHistoryScreen extends StatefulWidget {
  ...
  @override
  State<TransactionHistoryScreen> createState() => TransactionHistoryPage();
}

class TransactionHistoryPage extends State<TransactionHistoryScreen> {
  ...
  Future<void> _checkForScanUpdates() async {
    ...
    final response = await http.get(
      Uri.parse('$ipaddress/client_history/${userId.toString()}'),
      headers: {
